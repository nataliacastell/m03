...
public class programa_acabat {
	public static void main(String[] args) {
 	      ...
 	      System.out.println("-------------------------------------------");
 	    		...
 	    		//Aquestes variables s�n la distancia que hi ha des de la Terra als altres planetes.
 	    		...
 	    		//Variable dies m�xims per arribar vius.
 	    		int dviu = 500;
 	    		
 	    		try (//Farem que l'usuari pugui introduir la velocitat mitjan�ant un scanner.
				Scanner keyboard = new Scanner(System.in)) {
 	    		...
 	    		//�s el missatge que mostrar� el programa,		
